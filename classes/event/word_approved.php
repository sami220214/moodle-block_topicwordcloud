 ...
 */
class word_approved extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventwordapproved', 'block_topicwordcloud');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' approved '$wordcount' occurrences of the word '$word' in " .
