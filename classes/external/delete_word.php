...
class delete_word extends base {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'word' => new external_value(PARAM_RAW_TRIMMED, 'Word to delete'),
        ]);
    }
    ...
    public static function execute(int $blockinstanceid, string $word): array {
        ...
        [$state, $message] = manager::delete_word($params['blockinstanceid'], $params['word']);
